...
* - [SuperMajor](https://www.supermajor.gg/)
  - Easily search yours and other (eg top ranked) players tourney results (along with nice high level summarys)
...
below is full list of [Noteable Players](noteable_players) vods per MU
